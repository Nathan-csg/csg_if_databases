...
****************************/
     ...
     $fibonacci=array(0,1);
      ...
      echo 'De array van Fibonacci heeft nu '.count($fibonacci).' getallen.';
      ...
      while ($doorgaan) {
        ...
        $deel2=false;
        $deel3=false;
        //Omdat de delen wel op false moeten staan, anders weet de computer niet of het met true of false start//
      }
